...
namespace Facec.WebApi
{
    ...
    {
        private const string _mySQLConnection = @"Server=localhost;User Id=root;Password=root;
            DataBase=facecwebapi";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DataBaseContext>(options => options.UseMySQL(_mySQLConnection),
